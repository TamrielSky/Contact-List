...
public class CallLogPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) {
        ...
        Log.d("calllogplugin", "Plugin Called now");
        ...
        if (ACTION_CONTACT.equals(action)) {
            ...
            show(args, callbackContext);
		        ...
		        Log.d("calllogplugin", "list Plugin Called");
        ...
        cordova.getThreadPool().execute(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    Log.d("calllogplugin", "Returning " + callLog.toString());
   		...
   		try {
            Cursor callLogCursor = this.cordova.getActivity().getContentResolver().query(
                    android.provider.CallLog.Calls.CONTENT_URI,
   					strFields,
   					"type = ? OR type = ? ",
   	                new String[] { String.valueOf(android.provider.CallLog.Calls.OUTGOING_TYPE), String.valueOf(android.provider.CallLog.Calls.INCOMING_TYPE)},
   					"date desc");
